...
db.commandes.insertMany([
    { idMembre: { "$ref": "membres", "$id": { "$oid": "67800070c5f2fb32c3f37bc3" } }, idVendeur: { "$ref": "membres", "$id": { "$oid": "67be408f933d5116a45a1550" } }, date: new Date("2024-11-15T10:30:00Z"), liste: [{ idMateriel: 1, numeroSerie: "123456", modele: "Inspiron", type: "LAPTOP", marque: "Dell", prix: 500 }], prixTotal: 500, codePostal: 75001 },
    { idMembre: { "$ref": "membres", "$id": { "$oid": "67800070c5f2fb32c3f37bc3" } }, idVendeur: { "$ref": "membres", "$id": { "$oid": "67be408f933d5116a45a1550" } }, date: new Date("2025-01-05T14:00:00Z"), liste: [{ idMateriel: 2, numeroSerie: "789012", modele: "Pavilion", type: "LAPTOP", marque: "HP", prix: 600 }, { idMateriel: 3, numeroSerie: "345678", modele: "ThinkPad", type: "LAPTOP", marque: "Lenovo", prix: 550 }], prixTotal: 1150, codePostal: 69000 },
    { idMembre: { "$ref": "membres", "$id": { "$oid": "67800070c5f2fb32c3f37bc3" } }, idVendeur: { "$ref": "membres", "$id": { "$oid": "67be408f933d5116a45a1550" } }, date: new Date("2025-02-10T09:15:00Z"), liste: [{ idMateriel: 4, numeroSerie: "901234", modele: "MacBook", type: "LAPTOP", marque: "Apple", prix: 1200 }], prixTotal: 1200, codePostal: 6000 },
    { idMembre: { "$ref": "membres", "$id": { "$oid": "67800070c5f2fb32c3f37bc3" } }, idVendeur: { "$ref": "membres", "$id": { "$oid": "67be408f933d5116a45a1550" } }, date: new Date("2025-03-22T18:45:00Z"), liste: [{ idMateriel: 5, numeroSerie: "567890", modele: "VivoBook", type: "LAPTOP", marque: "Asus", prix: 700 }, { idMateriel: 6, numeroSerie: "yu", modele: "yu", type: "ECRAN", marque: "yu", prix: 5 }], prixTotal: 705, codePostal: 14000 },
    { idMembre: { "$ref": "membres", "$id": { "$oid": "67800070c5f2fb32c3f37bc3" } }, idVendeur: { "$ref": "membres", "$id": { "$oid": "67be408f933d5116a45a1550" } }, date: new Date("2025-04-10T20:10:00Z"), liste: [{ idMateriel: 1, numeroSerie: "123456", modele: "Inspiron", type: "LAPTOP", marque: "Dell", prix: 500 }, { idMateriel: 3, numeroSerie: "345678", modele: "ThinkPad", type: "LAPTOP", marque: "Lenovo", prix: 550 }, { idMateriel: 5, numeroSerie: "567890", modele: "VivoBook", type: "LAPTOP", marque: "Asus", prix: 700 }], prixTotal: 1750, codePostal: 59000 }
]);